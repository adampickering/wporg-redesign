...
export function Footer() {
	return (
		<footer className="bg-[#23282D]">
			...
			{/* Massive wordmark — oversized brand anchor like Ditto/Automattic Design */}
			<div className="overflow-hidden border-t border-white/5 px-8 pt-16 pb-8">
				<div className="mx-auto max-w-[1280px] text-white/[0.07]">
					<WordPressWordmark />
				</div>
			</div>
		</footer>
